  ...
  if user_input:
    ...
    query = f"""
      ...
      The following is a question the user is asking:
       ...
       The boolean field "is_request_data" is true when the user is requesting for data for 
       buildings, power stations and underground storage tanks, otherwise false.
